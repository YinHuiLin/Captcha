...
def image_transfer(image_array, captcha_clean_save = False):
    """
    图像粗清理
...
def image_save(image_array, image_label):
    ...
    for num, image_meta in enumerate(image_array):
        file_path = captcha_clean_path + image_label[num] + '/'
...
def main():
    ...
    image_clean = image_transfer(image_array, image_label, captcha_clean_path) #验证码图像粗清理
